  ...
  return (
    <div ref={ref} className="relative">
      ...
      <button
        ...
        disabled={loading}
        className="w-full flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-gray-900 shadow-sm hover:border-gray-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition text-left cursor-pointer disabled:opacity-50"
      >
        {loading ? (
        ...
        <div className="absolute z-30 mt-1 w-full bg-white rounded-lg border border-gray-200 shadow-lg overflow-hidden">
          <div className="p-2 border-b border-gray-100">
            <input
              ...
              className="w-full px-3 py-2 text-sm border border-gray-200 rounded-md outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-200"
            />
          </div>
              ...
              filtered.map((c) => (
                <li key={c.id}>
                  <button
                    ...
                    className={`w-full flex items-center gap-2 px-4 py-2 text-sm text-left hover:bg-blue-50 transition cursor-pointer ${
